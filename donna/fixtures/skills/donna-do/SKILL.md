...
1. You **MUST** read the `<project-root>/.agents/donna/intro.md` file when you start executing this skill, if you haven't done it yet. This file gives you an introduction to the project and to the Donna tool.
...
**If you are rebuilding, zipping or optimizing your context while executing this skill, read the `<project-root>/.agents/donna/intro.md` file again after rebuilding, zipping or optimizing your context to refresh your understanding of the project and Donna tool.**
