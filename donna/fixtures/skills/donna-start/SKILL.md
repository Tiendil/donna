...
1. You **MUST** run `donna -p llm -r <project-root> artifacts view '**/intro.donna.md'` when you start executing this skill, if you haven't done it yet. This command provides an introduction to the project and the Donna tool.
