...
If not otherwise specified, Design documents for the session MUST be stored as `project:.donna:session:design:<short-problem-related-identifier>` artifacts under `<project-root>/.donna/session`.
