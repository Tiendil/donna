...
3. Read the specification `{{ donna.lib.view(".agents:donna:usage:artifacts") }}` if you haven't done it yet.
...
1. If the name of the artifact is not specified explicitly, assume it to `.donna:session:plans:<short-id-equal-to-design-slug>`.
