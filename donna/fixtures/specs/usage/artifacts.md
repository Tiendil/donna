...
Read the specification `{{ donna.lib.view("project:.agents:donna:usage:cli") }}` to learn how to work with artifacts via Donna CLI.
...
The canonical list of standard tags is documented in `project:.agents:donna:intro`.
