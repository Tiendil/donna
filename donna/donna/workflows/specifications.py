...
spec_world_layout = Specification(
    item=SpecificationIndexItem(
        id=SpecificationId(types.NestedId("donna:world-layout")),
        name="Donna World Layout",
        description=(
...
donna_workflows = StaticSpecificationSource(
    ...
    specifications=[spec_planning, spec_world_layout]
)
