...
4. Create new session-level specification `session:usage:work_scope` with developer-provided description of the work to be done.
...
4. Add this description to the `session:usage:work_scope`.
...
1. Read the specification `{{ donna.lib.view("donna:work:planning") }}` if you haven't done it yet.
2. Read the specification `{{ donna.lib.view("donna:usage:artifacts") }}` if you haven't done it yet.
3. If you can add more goals based on existing `{{ donna.lib.view("session:usage:work_scope") }}` add them to the specification.
...
1. Read the specification `{{ donna.lib.view("donna:work:planning") }}` if you haven't done it yet.
2. Read the specification `{{ donna.lib.view("donna:usage:artifacts") }}` if you haven't done it yet.
3. If you can add more objectives based on existing `{{ donna.lib.view("session:usage:work_scope") }}` add them to the specification.
...
1. Read the specification `{{ donna.lib.view("donna:work:planning") }}` if you haven't done it yet.
2. Read the specification `{{ donna.lib.view("donna:usage:artifacts") }}` if you haven't done it yet.
3. If you can add more constraints based on existing `{{ donna.lib.view("session:usage:work_scope") }}` add them to the specification.
...
1. Read the specification `{{ donna.lib.view("donna:work:planning") }}` if you haven't done it yet.
2. Read the specification `{{ donna.lib.view("donna:usage:artifacts") }}` if you haven't done it yet.
3. If you can add more acceptance criteria based on existing `{{ donna.lib.view("session:usage:work_scope") }}` add them to the specification.
...
1. Read the specification `{{ donna.lib.view("donna:work:planning") }}` if you haven't done it yet.
2. Read the specification `{{ donna.lib.view("donna:usage:artifacts") }}` if you haven't done it yet.
3. If you can list more deliverables based on existing `{{ donna.lib.view("session:usage:work_scope") }}` add them to the specification.
...
1. Read the specification `{{ donna.lib.view("donna:work:planning") }}` if you haven't done it yet.
2. Read the specification `{{ donna.lib.view("donna:usage:artifacts") }}` if you haven't done it yet.
3. Read the specification `{{ donna.lib.view("session:usage:work_scope") }}` if you haven't done it yet.
4. Create new session-level workflow `session:work:work_execution` according to the scope of work you have defined.
...
1. Run workflow `session:work:work_execution` to execute the work according to the plan.
