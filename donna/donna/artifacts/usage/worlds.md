...
- `donna` — `<donna-package-code>/artifacts` — the standard donna-provided artifacts.
...
├── usage/ — a folder containing usage/specification files that define various aspects of the current project.
├── work/ — a folder containing workflow definitions that Donna can use to perform complex tasks.
```
