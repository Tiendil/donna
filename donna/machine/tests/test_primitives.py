...
class TestResolvePrimitive:
    ...
    def test_invalid_import_path_without_attribute_name(self) -> None:
        result = resolve_primitive(PythonPath(NormalizedRawIdPath("primitive")))
    ...
    def test_module_not_importable(self) -> None:
        result = resolve_primitive(PythonPath(NormalizedRawIdPath("donna.machine.tests.missing.sample_primitive")))
    ...
    def test_primitive_not_available(self) -> None:
        result = resolve_primitive(
            PythonPath(NormalizedRawIdPath("donna.machine.tests.test_primitives.missing_primitive"))
        )
    ...
    def test_object_is_not_primitive(self) -> None:
        result = resolve_primitive(
            PythonPath(NormalizedRawIdPath("donna.machine.tests.test_primitives.sample_non_primitive"))
        )
