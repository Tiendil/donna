...
** Store relations in the records index
** cli commands to add/remove relations
** storage of allowed relation types
** operations to validate that each list item has required relations
