...
* TODO Donna treat as duplicates temporary files, `like my-file.md~` (process only files with supported extensions)
** world should not see artifacts/files with unsupported extensions, i.e. should fully ignore them, do not apply checks, etc.
...
* TODO output cell progress with instruction to codex to output summary when it gets control
* TODO improve directives documentation
** Add information about two stage rendering
** to each directive add information about when it is applied (rendering stage)
