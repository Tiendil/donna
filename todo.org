...
** DONE Schema must be built with a list of items in mind
...
** DONE record name should be allowed to be None in record kind spec
** DONE goal record kind is registered
** DONE goal kind/record need ids generation logic
