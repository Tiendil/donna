...
** Cli command should start in the same environment as the donna runs
** Cli commands should be specified as a string and interpreted as a shell command, pipes are allowed
