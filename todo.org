...
** Id questions
*** should donna allow first-found replacement of artifacts in the paths? Or make 3 level ids: world/namespace/artifact_id?
*** artifact ids: specifications/xxx.md -> specification.xxx or specification:xxx? To make artifacts format agnostic (for the future)
