...
*** `Read the specification `donna.specifications.planning` if you haven't done it yet.` -> jinjaglobal to reference specification.
*** add specification reference check to validation step
