...
** Full paths to kinds
*** Directives, what to do with them?
**** always import <world>.defaults?
**** or always import <world>.directives?
**** config to autoload some modules?
**** `builtins`!!! also for kinds? add parameter .builtins to the world?
*** remove primitives registry?
...
*** part of sections is referenced as `<world>.<artifact>:<section>` and part as `<world>.<artifact>.<section>`. Should we unify that?
