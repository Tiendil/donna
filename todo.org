...
** Replace custom output woth json logging (?), for the sake of ai agents, it is not big difference to use json instead of cells.
...
** Consider using https://github.com/toon-format/toon for json formatting in cells
