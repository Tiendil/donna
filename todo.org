...
*** just remove
*** h3 instead list items?
***  what statements derived from what?
***  with chatGPT
** remove old specs/workflows
** polush research loop
** add choosing solution between multiple alternatives loop.
