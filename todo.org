...
* TODO Workflow for explicit morphological analysis
* Possible bootstrap workflows
...
* TODO Planing loop improvement: before initial planing and on each loop try to found uncertain parts of tasks and ask developer to clarify them. Like in deep research.
