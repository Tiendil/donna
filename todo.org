...
** if the project is not found, check for .git directory and offer to create donna project there
** donna projects initialize -> donna workspace initialize
** update specs
*** rename projects -> workspaces
** donna/world -> donna/workspaces?
