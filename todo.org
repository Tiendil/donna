...
** TODO Schema must be built with a list of items in mind
** TODO Agent request instruction must
*** either describe the loop to process each item
*** or create a new task that organizes the loop
** TODO record name should be allowed to be None in record kind spec
** TODO goal record kind is registered
** TODO goal kind/record need ids generation logic
