...
* TODO Make all ids in the format <type>-<int>-<ascii-checksum> where ascii-checksum is just a representation of the integer in ascii symbols [a-zA-Z0-9], this will help to control mistakes from the agents and humans
...
** TODO custom command to run a specific subflow? Or whould we rest it to the agent? It look like agent can deside better.
