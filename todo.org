...
** DONE remove whole artifacts code
** TODO update AGENTS.md
** DONE update cli
** DONE register for record types
** DONE text type
** TODO tags for records
** DONE knowlege base
** TODO default format for record kinds? json vs toml
** DONE when deleting the whole record, also delete all its kinds
** TODO review & fix end_to_end_story_cycle
** TODO refactor cells, they mustn't require all ids
