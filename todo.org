...
*** if world does not know its name/path before initialization, how can it encode the full paths to its artifacts?
*** section constructor has a weired toml operations, we must remove them
** introspection
