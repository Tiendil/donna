...
* TODO Cells & Errors
** We may return to much info in cells now. Let's check that manually.
** Errors processing improvements
*** remove parse_or_raise
*** ways_to_fix should support formatting / jinja2? or should not contain the formating at all?
*** try simplify error handling code with a kind of decorator on functions or smth like that
...
*** internal-exceptions-mode for cli to specify that stack traces must be shown?
*** DirectivePathBuilder — how to pass errors to the user?
*** cleanup comments above `raise ...`
*** polish ways_to_fix lists
*** review the code
...
* TODO Environment errors should provide references to th especifications that explain how to fix them
* TODO Process and remove ./long-term-dev-notes/*
