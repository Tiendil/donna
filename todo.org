...
* TODO Cells & Errors
** Add dictionary to the project:intro specification.
** Errors processing improvements
*** specification on how we process errors
**** we raise errors that is cause by donna bugs
**** we return errors that is caused by environment issues (invalid artifacts)
