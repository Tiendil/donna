...
**** add validation that the workflow has a single start operation
*** chapter meta
** artifact has:
*** info
*** meta
...
** artifact kind id should be full (with namespace)? the same for all other ids?
