...
*** explicit is better than implicit => hiden control flow logic will mess with agents.
*** we should wait till use cases appear that require or prohibit such unification.
