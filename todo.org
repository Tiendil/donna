...
** Id questions
*** DONE normal id classes/types
*** DONE 3-level ids: world/namespace/artifact_path
*** DONE no shadowing of artifacts in namespaces
*** DONE ids as world.kind.artifact_path_with_extension
*** DONE an additional map of namespaces in primitives_register, to separate artifact kind id from artifact kind namespace
*** DONE session as one more world
