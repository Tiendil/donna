...
** hypothesis-driven approach for workflow or steps
** risk-driven approach for workflow or steps
** fast track workflow for small tasks
*** generate plan & execute
** log of work and agent actions
** implement tags for operations/workflows
*** remove intermediate folders `specs` & `work`
...
*** *we can have cli command to add/update/remove items from lists in artifacts (proposal)
