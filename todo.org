...
** PythonArtifact is a part of donna.world.worlds.python?
*** it should be possible to construct Workflow and Specification from the python artifact as well as from markdown artifact
*** => smth like PythonArtifact (and related classes) should be an intemediate representation for .py files
*** => and we should have smth like MarkdownArtifact for .md files
*** both should implement allow construction of artifact kinds (specification, workflow) in generic way
** Do we need artifact kinds? Maybe sections will be enough?
** introspection
